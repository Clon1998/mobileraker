...
void main() {
  ...
  group('GenericHeater partialUpdate', () {
    ...
    test('temperature Histories', () {
      ...
      expect(genericHeater.temperatureHistory,
          orderedEquals([30, 30, 31, 31, 32.5, 44, 45, 45, 9]));
      expect(genericHeater.targetHistory,
          orderedEquals([0, 0, 0, 1.4, 2, 3, 4, 5, 6, 7, 8, 8, 9]));
      expect(genericHeater.powerHistory,
          orderedEquals([0, 0, 0, 0, 0.5, 0.9, 1.0]));
    });
  });
}
...
GenericHeater genericHeaterObject() {
  ...
  var parsedJson =
      objectFromHttpApiResult(input, "heater_generic Loool_Heater");
