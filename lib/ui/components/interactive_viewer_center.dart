...
/// {@end-tool}
@immutable
class CenterInteractiveViewer extends StatefulWidget {
  ...
  ///
  /// Passed with the [CenterInteractiveViewer.builder] constructor. Otherwise, the
  ...
  final CenterInteractiveViewerWidgetBuilder? builder;

  /// The child [Widget] that is transformed by InteractiveViewer.
  ///
  /// If the [CenterInteractiveViewer.builder] constructor is used, then this will be
  ...
  @override
  State<CenterInteractiveViewer> createState() => _CenterInteractiveViewerState();
}

class _CenterInteractiveViewerState extends State<CenterInteractiveViewer> with TickerProviderStateMixin {
  TransformationController? _transformationController;
...
/// See also:
///
///  * [CenterInteractiveViewer.transformationController] for detailed documentation
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return CenterInteractiveViewer.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside = CenterInteractiveViewer.getNearestPointInside(point, boundary);
