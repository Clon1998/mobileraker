...
class HomedAxisChip extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    int homedAxisCnt = ref.watch(provider.selectAs((value) => value.toolhead.homedAxes.length)).value ?? 0;
    ...
    return Tooltip(
      ...
      child: Chip(
        ...
        label: Text(_homedChipTitle(ref.read(provider).value?.toolhead.homedAxes ?? {})),
        // backgroundColor:
