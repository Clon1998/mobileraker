...
class HistoryParams with _$HistoryParams {
  const factory HistoryParams({
    @IntegerConverter() required int start, // Record number to start from (i.e. 10 would start at the 10th print)
    @IntegerConverter() required int limit, // Maximum Number of prints to return (default: 50)
